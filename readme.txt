...
1 - creiamo un ciclo for che va da 1 a 100
2 - dentro il ciclo mettiamo un if
3 - se il numero è divisibile per 3 stamperà fizz
4 - se il numero è div per 5 stamper buzz
5 - se è divisibile per entrambi stamperà fizzbuzz